...
import { WA, PRODUCTS } from "../data/products.js";
...
const GALLERY_ITEMS = [
  { icon: "🎴", en: "Premium Business Cards", bn: "প্রিমিয়াম বিজনেস কার্ড", cat: "business", bg: "linear-gradient(135deg,#1a0f00,#2a1500)", img: "/images/visitingcard.jpeg" },
  { icon: "🗞", en: "Glossy A5 Flyers", bn: "গ্লসি A5 ফ্লায়ার", cat: "marketing", bg: "linear-gradient(135deg,#001520,#001a2a)", img: "/images/labels.jpeg" },
  { icon: "📕", en: "Hardcover Books", bn: "হার্ডকভার বই", cat: "books", bg: "linear-gradient(135deg,#00150d,#001a12)", img: "/images/books.jpeg" },
  { icon: "🪪", en: "Holographic ID Cards", bn: "হলোগ্রাফিক আইডি কার্ড", cat: "id", bg: "linear-gradient(135deg,#150010,#1a0015)", img: "/images/certificate.jpeg" },
  { icon: "🎁", en: "Custom Gift Boxes", bn: "কাস্টম গিফট বক্স", cat: "packaging", bg: "linear-gradient(135deg,#150a00,#1a1000)", img: "/images/packaging.jpeg" },
  { icon: "🪧", en: "Roll-up Banners", bn: "রোল-আপ ব্যানার", cat: "signage", bg: "linear-gradient(135deg,#001515,#001a1a)", img: "/images/posters.jpeg" },
  { icon: "📓", en: "Spiral Notebooks", bn: "স্পাইরাল নোটবুক", cat: "books", bg: "linear-gradient(135deg,#0a1500,#0f1a00)", img: "/images/billbook.jpeg" },
  { icon: "🛍", en: "Paper Bags", bn: "পেপার ব্যাগ", cat: "packaging", bg: "linear-gradient(135deg,#0a0015,#0f001a)", img: "/images/packaging.jpeg" },
  { icon: "📰", en: "Magazines", bn: "ম্যাগাজিন", cat: "books", bg: "linear-gradient(135deg,#001500,#001a00)", img: "/images/books.jpeg" },
  { icon: "💡", en: "Neon Signs", bn: "নিয়ন সাইন", cat: "signage", bg: "linear-gradient(135deg,#150015,#1a001a)", img: "/images/posters.jpeg" },
  { icon: "🏷", en: "Product Labels", bn: "প্রোডাক্ট লেবেল", cat: "packaging", bg: "linear-gradient(135deg,#150500,#1a0800)", img: "/images/labels.jpeg" },
  { icon: "📋", en: "Thesis & Reports", bn: "থিসিস ও রিপোর্ট", cat: "books", bg: "linear-gradient(135deg,#001015,#00151a)", img: "/images/letterhead.jpeg" },
];
...
export default function HomePage() {
  ...
  return (
    <div style={{ background: BG, color: TXT, minHeight: "100vh", fontFamily: "'Outfit','Nunito',sans-serif", overflowX: "hidden", transition: "background 0.4s, color 0.4s" }}>
      ...
      {/* ══ PRODUCT CATALOG ══ */}
      <section id="products" style={{ padding: "0 5% 96px" }}>
        <div style={{ background: or, textAlign: "center", padding: "18px 12px", borderRadius: 8, marginBottom: 40 }}>
          <h2 style={{ fontSize: "clamp(20px,3vw,28px)", fontWeight: 800, color: "#fff", margin: 0 }}>
            {bn ? "আমাদের সার্ভিস সমূহ" : "OUR SERVICES"}
          </h2>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(230px,1fr))", gap: 24 }}>
          {PRODUCTS.map((p, i) => (
            <RevealOnScroll key={p.en} delay={i * 60}>
              <Link to={`/product/${p.slug}`} style={{ textDecoration: "none" }}>
                <div style={{ background: "#fff", border: "1px solid #eee", borderRadius: 10, overflow: "hidden", boxShadow: "0 2px 10px rgba(0,0,0,0.06)", transition: "transform 0.25s, box-shadow 0.25s", cursor: "pointer" }}
                  ...
                  <div style={{ position: "relative", aspectRatio: "1", background: "#f7ede3", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
                    {!p.inStock && (
                      <div style={{ position: "absolute", top: 10, left: 10, background: "#e74c3c", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 10px", borderRadius: 4, zIndex: 2 }}>
                    ...
                    {p.img ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, color: "#b8a99a" }}>
                        <span style={{ fontSize: 44 }}>{p.icon}</span>
                        <span style={{ fontSize: 11, fontWeight: 600 }}>{bn ? "ছবি শীঘ্রই আসছে" : "Photo coming soon"}</span>
                      </div>
                    )}
                  </div>
                  <div style={{ padding: "18px 16px", textAlign: "center" }}>
                    <h3 style={{ fontSize: 16, fontWeight: 700, color: "#1a1a1a", margin: "0 0 8px" }}>{bn ? p.bn : p.en}</h3>
                    <div style={{ color: "#f5a623", fontSize: 13, marginBottom: 8, letterSpacing: 2 }}>☆☆☆☆☆</div>
                    {p.priceMin ? (
                      <div style={{ color: or, fontWeight: 700, fontSize: 14, marginBottom: 14 }}>
                        ৳{p.priceMin} – ৳{p.priceMax}
                      </div>
                    ) : (
                      <div style={{ height: 14, marginBottom: 14 }} />
                    )}
                    <span style={{ display: "block", background: "#1a56c4", color: "#fff", fontSize: 13, fontWeight: 700, padding: "10px 0", borderRadius: 6 }}>
                      {bn ? "✔ অর্ডার করুন" : "✔ Order Now"}
                    </span>
                  </div>
                </div>
